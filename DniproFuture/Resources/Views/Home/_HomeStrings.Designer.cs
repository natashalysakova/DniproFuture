...
namespace ViewRes {
    ...
    public class _HomeStrings {
        ...
        ///&lt;p&gt;Ми - це БФ &amp;laquo;Майбутнє Дніпра&amp;raquo;. Ми надаємо матеріальну та юридичну допомогу людям Дніпропетровська. І нам потрібна Ваша допомога! [rest of string was truncated]&quot;;.
        /// </summary>
